<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="edu.fau.group3.model.Product" import="java.util.List"%>
...
<body>
	...
	<%
		...
		if (uid == null) {
	%>
	<a href="signup.jsp">Log in or make an account</a>
	<%
		}
	%>
	...
	<div class="topnav">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				...
				%>
				<a
					href="Product.jsp?collectionID=<%=Collections.get(i).getCollectionID()%>">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				...
				%>
				<a href="ProductPage.jsp?productID=<%= product.get(i).getProductID()%>">
