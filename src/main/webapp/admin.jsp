<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="edu.fau.group3.model.User"
	import="edu.fau.group3.model.Collection"
	import="edu.fau.group3.model.Product"
	import="edu.fau.group3.util.DBUtil" import="java.util.List"%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="column">
				...
				<form action="Upload.jsp?UploadType=Product" method="post">
					...
					<p>
						<label>Product Description: </label> <input type="text"
							maxlength="4" name="ProductDesccription" required>
					</p>
					<p>
						<label>Product SKU: </label> <input type="text" name="ProductSKU"
							required>
					</p>
					<p>
						<label>Product Inventory: </label> <input type="text"
							name="ProductInv">
					</p>
					<p>
						<label>ImageListID: </label> <input type="text" name="ImageListID"
							required>
					</p>
					<p>
						<label>Image Thumbnail URL: </label> <input type="text" name="ImageThumbnail">
					</p>
					<p>
						<label>Image 1 URL: </label> <input type="text" name="Image1">
					</p>
					<p>
						<label>Image 2 URL: </label> <input type="text" name="Image2">
					</p>
					<p>
						<label>Image 3 URL: </label> <input type="text" name="Image3">
					</p>
					<p>
						<label>Image 4 URL: </label><input type="text" name="Image4">
					</p>
					...
					<select name="CollectionID">
						...
						%><option
							value="<%=collections.get(i).getCollectionID()%>">
							<%=collections.get(i).getCollectionName()%>
						</option>
						<%
							}
						%>
			...
			<form action="Upload.jsp?UploadType=User" method="post">
				<fieldset>
					...
					<h5 id="Info">
						AdminStatus: <select name="AdminStatus">
			...
			<form action="Upload.jsp?UploadType=Collection" method="post">
				<fieldset>
					<div>
						...
						<p>
							<label>Collection Name: </label> <input type="text"
								name="CollectionName" required>
						</p>
						<p>
							<label>CollectionThumbnail: </label> <input type="text"
			...
			<form action="modifycollectionsform.jsp" method="post">
				<fieldset>
					...
					<input type="text" name="CollectionName"
						placeholder="Search CollectionName.."> <input id="button"
			...
			<form action="modifyproductsform.jsp" method="post">
				<fieldset>
					...
					<input type="text" name="ProductSKU"
						placeholder="Search ProductSKU.."> <input id="button"
						type="Submit" Value="Search">
				</fieldset>
			</form>
